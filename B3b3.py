...
\033[1;91m       ♦♦♦————————————————————————————————————————————————————————————♦♦♦
\033[1;96m                               ☠️ 💀 👻 🤡 👹 👾 👽 ☠️                  
\033[1;96m          __   __ _ __   __ _    _   _   ___ _   _ _____  _    _   _    
\033[1;96m          \ \ / // \\ \ / // \  | \ | | |_ _| \ | |_   _|/ \  | \ | |   
\033[1;96m           \ V // _ \\ V // _ \ |  \| |  | ||  \| | | | / _ \ |  \| |   
\033[1;96m            | |/ ___ \| |/ ___ \| |\  |  | || |\  | | |/ ___ \| |\  |   
\033[1;96m            |_/_/   \_\_/_/   \_\_| \_| |___|_| \_| |_/_/   \_\_| \_|   
\033[1;96m                                 YAYAN 🐻 ❤ INTAN                      
\033[1;96m                                            YAYAN 🐻 ❤ INTAN           
\033[1;91m        ♦♦♦———————————————————————————————————————————————————————————♦♦♦
"""
def tik():
...
CorrectPassword = "Intan"


loop = 'true'
while (loop == 'true'):
    username = raw_input("\033[1;96m[☆] \x1b[1;97mMASUKAN USERNAME TOOLS INI \x1b[1;96m>>>> ")
    if (username == CorrectUsername):
    	password = raw_input("\033[1;96m[☆] \x1b[1;97mMASUKAN PASSWORD TOOLS INI \x1b[1;96m>>>> ")
        if (password == CorrectPassword):
            print "Logged in successfully as " + username
            loop = 'false'
        else:
            print "Password Salah Peler,Tunggu Sebentar Sedang Di Alihkan Ke Passwordnya"
            os.system('xdg-open https://www.facebook.com/YAYAN.XING.ZUCKERBERG.SR')
    else:
        print "Username Salah Pelerr,Tunggu Sebentar Sedang Di Alihkan Ke Kode Usernamenya"
        os.system('xdg-open https://www.facebook.com/YAYAN.XING.ZUCKERBERG.SR')
...
def login1():
	...
	try:
		...
		print logo
		print 42*"\033[1;97m="
		jalan('\033[1;96m[✾]\x1b[1;91mJANGAB GUNAKAN AKUN OLD UNTUK LOGIN\x1b[1;96m[✾]' )
...
def super():
	...
	print logo
        print 42*"="
	jalan( "\x1b[1;32;92m[1] \033[1;33;98m>> Hack Teman Publik") 
